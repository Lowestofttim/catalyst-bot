...
# Fingerprint route moved to blueprints/sage.py



# CAT routes + helpers moved to blueprints/cat.py

# Full-node status moved to blueprints/sage.py
# Settings routes moved to blueprints/config_bp.py

# ---------------------------------------------------------------------------
# Check Resume (GUI startup)
# ---------------------------------------------------------------------------

# Check-resume route moved to blueprints/config_bp.py
